...
int PinLED = 13;                           //Definimos el pin de salida - GPIO13 / D7
int estado = HIGH;                         //Definimos la variable que va a recoger el estado del LED
 
void setup() {
  Serial.begin(115200);
 
  pinMode(PinLED, OUTPUT);                //Inicializamos el GPIO13 como salida
  digitalWrite(PinLED, HIGH);              //Dejamos inicialmente el GPIO13 apagado
